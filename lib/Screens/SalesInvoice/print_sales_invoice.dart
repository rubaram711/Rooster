...
class _PrintSalesInvoiceState extends State<PrintSalesInvoice> {
  ...
  Future<void> generatePdfFromImageUrl(String companyLogo) async {
    ...
    if (response.statusCode != 200) {
      ...
      salesInvoiceController.logoBytes = imageBytes;
    }
  }
          ...
          children: [
            ...
            SizedBox(
              ...
              child: PdfPreview(
                ...
                pdfFileName:
                    '${widget.clientName} [${widget.salesInvoiceNumber}]',
              ),
            ),
          ],
        ),
  ...
  Future<void> _savePdf(BuildContext context) async {
    ...
    final anchor =
        web.HTMLAnchorElement()
          ..href = url
          ..download = '${widget.clientName} [${widget.salesInvoiceNumber}].pdf'
          ..style.display = 'none'
          ..click();
                  ...
                  pw.Row(
                    ...
                    children: [
                      tableTitleForSequence(
                        text: 'Sales Invoice [${widget.salesInvoiceNumber}] ',
                        width: width * 0.1,
                      ),
                      ...
                      pw.Column(
                        ...
                        children: [
                          pw.SizedBox(
                            width: 135.w,
                            // width: width * 0.055,
                            child: reusableNumber(widget.salesInvoiceCurrency),
