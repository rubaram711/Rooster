...
class _PrintSalesInvoiceState extends State<PrintSalesInvoice> {
  ...
  Future<Uint8List> _generatePdf(
    ...
    final image = pw.MemoryImage(salesInvoiceController.logoBytes);
                ...
                pw.Container(
                  ...
                  child: pw.Column(
                    children: [
                      ...
                      primaryCurrency == widget.salesInvoiceCurrency?pw.SizedBox.shrink(): pw.Divider(
                        height: 5,
                        color: PdfColors.black,
                        // endIndent: 250
                      ),
