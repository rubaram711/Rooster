...
TextEditingController defaultTransactionPackageController = TextEditingController();
...
class _ShippingTabContentState extends State<ShippingTabContent> {
  ...
  void initState() {
    ...
    if(productController.isItUpdateProduct){
      ...
      int index = productController.packagesIds.indexOf('${productController.productsList[productController.selectedProductIndex]['defaultTransactionPackageType']}');
      defaultTransactionPackageController.text=productController.packagesNames[index];
    }
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        DropdownMenu<String>(
                          ...
                          width: widget.isDesktop
                              ? (MediaQuery.of(context).size.width * 0.19)+10
                          ...
                          dropdownMenuEntries: cont.packagesNames
          ...
          Row(
            children: [
              ...
              SizedBox(
                  ...
                  child: Text(suffix.toUpperCase())), //todo
            ],
          ),
        ],
      ),
