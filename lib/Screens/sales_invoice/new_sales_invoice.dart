...
class _CreateNewSalesInvoiceState extends State<CreateNewSalesInvoice> {
  ...
  // final SalesInvoiceController clientOrderController = Get.find();
  ...
  getFieldsForCreateQuotationFromBack() async {
    ...
    salesInvoiceNumber = p['quotationNumber'];
    if ('$p' != '[]') {
      setState(() {
        data.addAll(p);
        salesInvoiceNumber = p['quotationNumber'] as String;
  ...
  Widget build(BuildContext context) {
    return isSalesInvoiceInfoFetched
        ? Container(
...
////////////////////
                                ...
                                Expanded(
                                    ...
                                    child: ListTile(
                                      ...
                                      leading: Checkbox(
                                        ...
                                        value: isActiveDeliveredChecked,
                                        onChanged: (bool? value) {
                                          setState(() {
                                            isActiveDeliveredChecked = value!;
                                          });
                                        },
                                      ),
                                    )),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      DropdownMenu<String>(
                                        ...
                                        // menuStyle: ,
                                        menuHeight: 250,
                                        dropdownMenuEntries: wareHouseNamesList
                                            .map<DropdownMenuEntry<String>>(
                                                (String option) {
                                              return DropdownMenuEntry<String>(
                                                value: option,
                          ...
                          child: Row(
                              ...
                              children: [
                                ...
                                DropdownMenu<String>(
                                  ...
                                  // menuStyle: ,
                                  menuHeight: 250,
                                  dropdownMenuEntries: vatExemptListTrue
                                      .map<DropdownMenuEntry<String>>(
                                          (String option) {
                                        return DropdownMenuEntry<String>(
                                          value: option,
                                  ...
                                  onSelected: (String? val) {
                                    setState(() {
                                      if (val == 'prices are before vat'){
                                        isBeforeVatPrices = true;
                                        isVatInclusivePrices = false;
                                      }
                                      else {
                                        isBeforeVatPrices = false;
                                        isVatInclusivePrices = true;
                                      }
                                    });
                                  },
                                )
                                ...
                                DropdownMenu<String>(
                                  ...
                                  // menuStyle: ,
                                  menuHeight: 250,
                                  dropdownMenuEntries: vatExemptListFalse
                                      .map<DropdownMenuEntry<String>>(
                                          (String option) {
                                        return DropdownMenuEntry<String>(
                                          value: option,
                                  ...
                                  onSelected: (String? val) {
                                    setState(() {
                                      if (val == 'exempted from vat ,printed as "vat exempted"'){
                                        isPrintedAsVatExempt = true;
                                        isPrintedAsPercentage = false;
                                        isVatNoPrinted=false;
                                      }
                                      else if(val == 'exempted from vat ,printed as "vat 0 % = 0"')
                                      {
                                        isPrintedAsVatExempt = false;
                                        isPrintedAsPercentage = true;
                                        isVatNoPrinted=false;
                                      }
                                      else {
                                        isPrintedAsVatExempt = false;
                ...
                GetBuilder<QuotationsController>(builder: (cont) {
                  return Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(
                          height: quotationController
                              .listViewLengthInQuotation,
                          child: ListView.builder(
                            padding: const EdgeInsets.symmetric(
                                vertical: 10),
                            itemCount:cont
                                .rowsInListViewInQuotation.length, //products is data from back res
                            itemBuilder: (context, index) => Row(
                              children: [

                                ReusableItemRow(
                                  index: index,
                                  // info: cont.rowsInListViewInQuotation[index],
                                ),
  ...
  addNewItem() {
    ...
    quotationController.incrementListViewLengthInQuotation(quotationController.increment);
    var p = {
      'type': '2',
      'item': '',
      'discount':'0',
    ...
    quotationController.addToRowsInListViewInQuotation(p);
  }
  addNewCombo() {
    setState(() {
      listViewLength = listViewLength + increment;
...
class _ReusableItemRowState extends State<ReusableItemRow> {
  ...
  @override
  Widget build(BuildContext context) {
    return GetBuilder<QuotationsController>(builder: (cont) {
      return Container(
          ...
          child:  Row(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: InkWell(
                  onTap: () {
                    quotationController.decrementListViewLengthInQuotation(quotationController.increment);
                    quotationController.removeFromRowsInListViewInQuotation(widget.index);
                  },
                  child: Icon(
                    Icons.delete_outline,
                    color: Primary.primary,
...
class MobileCreateNewSalesInvoice extends StatefulWidget {
  const MobileCreateNewSalesInvoice({super.key});

  @override
  State<MobileCreateNewSalesInvoice> createState() =>
      _MobileCreateNewSalesInvoiceState();
}

class _MobileCreateNewSalesInvoiceState extends State<MobileCreateNewSalesInvoice> {
  // bool imageAvailable=false;
  ...
  getFieldsForCreateQuotationFromBack() async {
    ...
    if ('$p' != '[]') {
      setState(() {
        data.addAll(p);
        salesInvoiceNumber = p['salesInvoiceNumber'] as String;
        for (var client in p['clients']) {
          customerNameList.add('${client['name']}');
          customerIdsList.add('${client['id']}');
        }
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  isSalesInvoiceInfoFetched
                      ? Text(
                      salesInvoiceNumber, //'${data['salesInvoiceNumber'].toString() ?? ''}',
                      style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 20,
                          color: TypographyColor.titleTable))
