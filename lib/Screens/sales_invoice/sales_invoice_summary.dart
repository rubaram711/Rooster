...
class SalesInvoiceSummary extends StatefulWidget {
  ...
  @override
  State<SalesInvoiceSummary> createState() => _SalesInvoiceState();
}

class _SalesInvoiceState extends State<SalesInvoiceSummary> {
  ...
  getAllQuotationsFromBack()async{
    ...
    setState(() {
      salesInvoicesList.addAll(p);
      isQuotationsFetched=true;
      listViewLength = salesInvoicesList.length < 10
          ? Sizes.deviceHeight * (0.09 * salesInvoicesList.length)
            ...
            Row(
              ...
              children: [
                ...
                ReusableButtonWithColor(
                  ...
                  btnText: 'Create New Sale Invoice',
                ),
              ],
            ),
            gapH24,
              ...
              children: [
                      ...
                      tableTitleWithOrderArrow('number'.tr,
                          MediaQuery.of(context).size.width * 0.09, () {
                            setState(() {
                              ...
                              isNumberOrderedUp
                                  ? salesInvoicesList.sort((a, b) => a['salesInvoiceNumber'].compareTo(b['salesInvoiceNumber']))
                                  : salesInvoicesList.sort((a, b) => b['salesInvoiceNumber'].compareTo(a['salesInvoiceNumber']));
                            });
                          }),
                      tableTitleWithOrderArrow('creation'.tr,
                          MediaQuery.of(context).size.width * 0.09, () {
                            setState(() {
                              ...
                              isCreationOrderedUp?
                              salesInvoicesList.sort((a, b) => a['createdAtDate'].compareTo(b['createdAtDate']))
                                  :salesInvoicesList.sort((a, b) => b['createdAtDate'].compareTo(a['createdAtDate']));
                            });
                          }),
                      tableTitleWithOrderArrow('customer'.tr,
                          MediaQuery.of(context).size.width * 0.09, () {
                            setState(() {
                              ...
                              isCustomerOrderedUp?
                              salesInvoicesList.sort((a, b) => '${a['client']['name']}' .compareTo('${b['client']['name']}'))
                                  : salesInvoicesList.sort((a, b) => '${b['client']['name']}'.compareTo('${a['client']['name']}' ));
                            });
                          }),
                      tableTitleWithOrderArrow('salesperson'.tr,
                          MediaQuery.of(context).size.width * 0.09, () {
                            setState(() {
                              ...
                              salesInvoicesList.sort((a, b) => a['salesperson'].compareTo(b['salesperson'])):
                              salesInvoicesList.sort((a, b) => b['salesperson'].compareTo(a['salesperson']));
                            });
                          }),
                      TableTitle(
                        text: 'task'.tr,
                ...
                isQuotationsFetched
                  ...
                  child: ListView.builder(
                    itemCount:salesInvoicesList.length>9?selectedNumberOfRowsAsInt:salesInvoicesList.length,
                    itemBuilder: (context, index) => Column(
                      children: [
                        Row(
                          children: [
                            SalesInvoiceAsRowInTable(
                              info: salesInvoicesList[index],
                              index: index,
                            ),
                          ],
                        ),
                ...
                Row(
                  ...
                  children: [
                              ...
                              setState(() {
                                ...
                                if(val=='10'){
                                  listViewLength = salesInvoicesList.length < 10
                                      ?Sizes.deviceHeight * (0.09 * salesInvoicesList.length)
                                      : Sizes.deviceHeight * (0.09 * 10);
                                  selectedNumberOfRowsAsInt=salesInvoicesList.length < 10? salesInvoicesList.length:10;
                                }if(val=='20'){
                                  listViewLength = salesInvoicesList.length < 20
                                      ? Sizes.deviceHeight * (0.09 * salesInvoicesList.length)
                                      : Sizes.deviceHeight * (0.09 * 20);
                                  selectedNumberOfRowsAsInt=salesInvoicesList.length < 20? salesInvoicesList.length:20;
                                }if(val=='50'){
                                  listViewLength = salesInvoicesList.length < 50
                                      ? Sizes.deviceHeight * (0.09 * salesInvoicesList.length)
                                      : Sizes.deviceHeight * (0.09 * 50);
                                  selectedNumberOfRowsAsInt=salesInvoicesList.length < 50? salesInvoicesList.length:50;
                                }if(val=='all'.tr){
                                  listViewLength = Sizes.deviceHeight * (0.09 * salesInvoicesList.length);
                                  selectedNumberOfRowsAsInt= salesInvoicesList.length;
                                }
                              });
                            },
                          ),
                    ...
                    gapW16,
                    Text(selectedNumberOfRows=='all'.tr?'${'all'.tr} of ${salesInvoicesList.length}':'$start-$selectedNumberOfRows of ${salesInvoicesList.length}',
                        style: const TextStyle(
                            fontSize: 13, color: Colors.black54)),
                    gapW16,
                    InkWell(
...
class SalesInvoiceAsRowInTable extends StatelessWidget {
...
class MobileSalesInvoiceSummary extends StatefulWidget {
  const MobileSalesInvoiceSummary({super.key});

  @override
  State<MobileSalesInvoiceSummary> createState() => _MobileSalesInvoiceSummaryState();
}

class _MobileSalesInvoiceSummaryState extends State<MobileSalesInvoiceSummary> {
  final TextEditingController filterController = TextEditingController();
  TextEditingController searchController = TextEditingController();
  double listViewLength = 100;
  String selectedNumberOfRows = '10';
                          ...
                          isQuotationsFetched
                            ...
                            child: Column(
                              children: List.generate(
                                salesInvoicesList.length>9?selectedNumberOfRowsAsInt:salesInvoicesList.length,
                                    (index) =>Column(
                                  children: [
                                    Row(
                                      children: [
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              SizedBox(
                                                ...
                                                child: InkWell(
                                                  onTap: () async {
                                                    var res= await deleteQuotation('${salesInvoicesList[index]['id']}');
                                                    ...
                                                    if(res.statusCode==200){
                                                      ...
                                                      setState(() {
                                                        ...
                                                        salesInvoicesList.removeAt(index);
