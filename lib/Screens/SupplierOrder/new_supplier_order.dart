...
class _CreateNewSupplierOrderState extends State<CreateNewSupplierOrder> {
          ...
          child: SingleChildScrollView(
            child: GetBuilder<HomeController>(
              builder: (homeCont) {
                ...
                double referencrFieldWidth =
                    homeCont.isMenuOpened
                        ? MediaQuery.of(context).size.width * 0.185
                        : MediaQuery.of(context).size.width * 0.20;
                double customerNameRow =
                    homeCont.isMenuOpened
                                ...
                                Row(
                                  children: [
                                    ...
                                    DialogTextField(
                                      ...
                                      rowWidth: referencrRow,
                                      textFieldWidth: referencrFieldWidth,
                                      // rowWidth:
                                      //     MediaQuery.of(context).size.width *
                                      //     0.18,
                                      // textFieldWidth:
                                  ...
                                  children: [
                                    ...
                                    DropdownMenu<String>(
                                      ...
                                      onSelected: (String? val) {
                                        setState(() {
                                          selectedItem = val!;
                                          var index = customerNameList.indexOf(
                                            val,
                                          );
                                          selectedCustomerIds =
  ...
  addNewTitle() {
    ...
    Widget p = GetBuilder<HomeController>(
      builder: (homeCont) {
        double containerTitleRow =
            homeCont.isMenuOpened
                ? MediaQuery.of(context).size.width * 0.63
                : MediaQuery.of(context).size.width * 0.78;

        return Container(
          width: containerTitleRow,
        ...
        return InkWell(
          ...
          child: Container(
            ...
            child: DottedBorder(
              ...
              child: GetBuilder<HomeController>(
                builder: (homeCont) {
                  double containerImageRow =
                      homeCont.isMenuOpened
                          ? MediaQuery.of(context).size.width * 0.63
                          : MediaQuery.of(context).size.width * 0.78;

                  return SizedBox(
                    width: containerImageRow,
  ...
  addNewNote() {
    ...
    Widget p = GetBuilder<HomeController>(
      builder: (homeCont) {
        double containerNoteRow =
            homeCont.isMenuOpened
                ? MediaQuery.of(context).size.width * 0.63
                : MediaQuery.of(context).size.width * 0.78;

        return Container(
          width: containerNoteRow,
          margin: const EdgeInsets.symmetric(vertical: 5, horizontal: 10),
          child: ReusableTextField(
            textEditingController: controller, //todo
            isPasswordField: false,
...
class _MobileCreateNewSupplierOrderState
    extends State<MobileCreateNewSupplierOrder> {
  // bool imageAvailable=false;
  ...
  addNewTitle() {
    ...
    final titleWidth = MediaQuery.of(context).size.width; // Get width once
    Widget p = GetBuilder<HomeController>(
      builder: (homeCont) {
        double containertitleRow =
            homeCont.isMenuOpened ? titleWidth * 0.63 : titleWidth * 0.78;
        return Container(
          width: containertitleRow,
          margin: const EdgeInsets.symmetric(vertical: 5, horizontal: 10),
          child: ReusableTextField(
