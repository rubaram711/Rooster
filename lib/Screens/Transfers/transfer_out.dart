                                      ...
                                      Navigator.push(context, MaterialPageRoute(
                                          builder: (BuildContext context) {
                                            return PrintTransferIn(
                                              ...
                                              rowsInListViewInTransfer: transferCont.rowsInListViewInTransferOut,
                                            );
                                          }));
                                    } else {
                                      CommonWidgets.snackBar('error',
                                      ...
                                      return DropdownMenu<String>(
                                        ...
                                        onSelected: (String? val) {
                                          ...
                                          transferCont
                                              ...
                                              index]);
                                          transferController
                                              .getAllProductsFromBack(transferCont
                                                  .transferFromIdInTransferOut,'','');
                                          ...
                                          i++) {
                                            ...
                                            if ('$p' != '[]') {
                                              ...
                                              setState(() {
                                                ...
                                                [
                                                'qtyOnHandPackages'] = val.isNotEmpty?val:
                                    ...
                                    SizedBox(
                                      ...
                                      child: ListView.builder(
                                        ...
                                        itemCount: transferCont
                                            .rowsInListViewInTransferOut.length,
                                    ...
                                    Row(
                                      children: [
                                        ReusableAddCard(
                                          text: 'item'.tr,
                                          onTap: () {
                                            if (transferCont.transferToIdInTransferOut == '' || transferCont.transferFromIdInTransferOut == '' ) {
                                              CommonWidgets.snackBar('error',
                                                  'you must choose warehouses first');
                                            } else if(transferCont.productsCodes.isEmpty){
                                              CommonWidgets.snackBar('error',
                      ...
                      children: [
                        ReusableButtonWithColor(
                          width: MediaQuery.of(context).size.width *
                              0.15,
                          height: 45,
                          isDisable: transferCont.rowsInListViewInTransferOut.isEmpty,
                          onTapFunction: () async {
                            bool isThereItemsEmpty=false;
                            for (var map in transferCont.rowsInListViewInTransferOut) {
                              if (map!["itemId"] == '' || map!["transferredQty"] == '' ||  map!["transferredQty"] == '0') {
                                setState(() {
                                  isThereItemsEmpty=true;
                                });
                                break;
        ...
        return GestureDetector(
          ...
          child: ClipPath(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  color: transferCont.selectedTabIndex == index ? Primary.p20 : Colors.white,
                  border: transferCont.selectedTabIndex == index
                      ? Border(
...
class ReusableItemRow extends StatefulWidget {
  const ReusableItemRow({super.key, required this.index, required this.info,  this.isMobile=false});
  final int index;
  final bool isMobile;
  final Map info;
  @override
  ...
  getQTyOfItemInSourceWarehouseFromBack() async {
    ...
    if ('$p' != '[]') {
      setState(() {
        ...
        defaultTransactionPackageType= '${p['item']['defaultTransactionPackageType'] ?? '1'}';
                              ...
                              Container(
                                ...
                                child: Column(
                                  children: List.generate(
                                    transferCont.rowsInListViewInTransferOut
                                        .length,
