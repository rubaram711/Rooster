                                          ...
                                          builder: (cont) {
                                            return DropdownMenu<String>(
                                              ...
                                              onSelected: (String? val) async {
                                                ...
                                                for (int i = 0; i < transferCont.productsList.length; i++) {
...
class ReusableItemRow extends StatefulWidget {
  const ReusableItemRow({super.key, required this.index, this.isMobile=false, required this.focusNode, this.nextFocusNode});
  final int index;
  final bool isMobile;
...
class _ReusableItemRowState extends State<ReusableItemRow> {
  ...
  getInfo() async {
    setState(() {
      ...
      //     '${widget.index}', p['mainDescription'] ?? '');
      ...
      //     qtyOnHandPackagesInSource.isNotEmpty?qtyOnHandPackagesInSource: '0 ${p['packageUnitName'] ?? ''}');
      isDataFetched = true;
    });
  }
  ...
  addTheItemToItemsListInReplenish() {
    if (!transferController.itemsListInReplenish.containsKey(
      ...
      transferController.addToItemsListInReplenish('${widget.index}', {
