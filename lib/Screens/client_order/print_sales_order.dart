...
class _PrintSalesOrderState extends State<PrintSalesOrder> {
  ...
  Future<Uint8List> _generatePdf(
    ...
    // final image = pw.MemoryImage(salesOrderController.logoBytes);
                ...
                pw.Container(
                  ...
                  child: pw.Column(
                    children: [
                        ...
                        children: [
                          ...
                          pw.Column(
                            ...
                            children: [
                              pw.SizedBox(
                                width:width * 0.05,
                                child: reusableNumber(widget.salesOrderCurrency),
                      ...
                      primaryCurrency == widget.salesOrderCurrency?pw.SizedBox.shrink():  pw.Divider(
                        height: 5,
                        color: PdfColors.black,
                        // endIndent: 250
                      ),
                          ...
                          pw.Column(
                            ...
                            children: [
                              pw.SizedBox(
                                ...
                                child:
                                reusableNumber(
                                        widget.finalPriceBySalesOrderCurrency == '0'
                                            ? '0.00'
                                            : numberWithComma(
