...
class ReturnToSupplierSummary extends StatefulWidget {
  const ReturnToSupplierSummary({super.key});

  @override
  State<ReturnToSupplierSummary> createState() => _ReturnToSupplierState();
}

class _ReturnToSupplierState extends State<ReturnToSupplierSummary> {
  ...
  getAllQuotationsFromBack()async{
    ...
    setState(() {
      ...
      listViewLength = returnToSupplierList.length < 10
          ? Sizes.deviceHeight * (0.09 * returnToSupplierList.length)
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                // PageTitle(text: 'return_to_supplier'.tr),
                const PageTitle(text: 'Return To Suppliers'),
                ReusableButtonWithColor(
                  ...
                  // btnText: 'create_new_return_to_supplier'.tr,
                  btnText: 'Create New Return To Suppliers',
                ),
              ],
            ),
            gapH24,
            ...
            const ReusableChip(
              // name: 'all_return_to_supplier'.tr,
              name: 'All Return To Suppliers',
            ),
            Column(
              children: [
                Container(
                      ...
                      tableTitleWithOrderArrow('number'.tr,
                          MediaQuery.of(context).size.width * 0.09, () {
                            setState(() {
                              ...
                              isNumberOrderedUp
                                  ? returnToSupplierList.sort((a, b) => a['quotationNumber'].compareTo(b['quotationNumber']))
                                  : returnToSupplierList.sort((a, b) => b['quotationNumber'].compareTo(a['quotationNumber']));
                            });
                          }),
                      tableTitleWithOrderArrow('creation'.tr,
                          MediaQuery.of(context).size.width * 0.09, () {
                            setState(() {
                              ...
                              isCreationOrderedUp?
                              returnToSupplierList.sort((a, b) => a['createdAtDate'].compareTo(b['createdAtDate']))
                                  :returnToSupplierList.sort((a, b) => b['createdAtDate'].compareTo(a['createdAtDate']));
                            });
                          }),
                      tableTitleWithOrderArrow('customer'.tr,
                          MediaQuery.of(context).size.width * 0.09, () {
                            setState(() {
                              ...
                              isCustomerOrderedUp?
                              returnToSupplierList.sort((a, b) => '${a['client']['name']}' .compareTo('${b['client']['name']}'))
                                  : returnToSupplierList.sort((a, b) => '${b['client']['name']}'.compareTo('${a['client']['name']}' ));
                            });
                          }),
                      tableTitleWithOrderArrow('salesperson'.tr,
                          MediaQuery.of(context).size.width * 0.09, () {
                            setState(() {
                              ...
                              returnToSupplierList.sort((a, b) => a['salesperson'].compareTo(b['salesperson'])):
                              returnToSupplierList.sort((a, b) => b['salesperson'].compareTo(a['salesperson']));
                            });
                          }),
                      TableTitle(
                        text: 'task'.tr,
                ...
                isReturnToSupplierFetched
                    ?Container(
                  color: Colors.white,
                  height: listViewLength,
                  child: ListView.builder(
                    itemCount:returnToSupplierList.length>9?selectedNumberOfRowsAsInt:returnToSupplierList.length,
                    itemBuilder: (context, index) => Column(
                      children: [
                        Row(
                          children: [
                            QuotationAsRowInTable(
                              info: returnToSupplierList[index],
                              index: index,
                            ),
                          ],
                        ),
                ...
                Row(
                  ...
                  children: [
                              ...
                              setState(() {
                                ...
                                if(val=='10'){
                                  listViewLength = returnToSupplierList.length < 10
                                      ?Sizes.deviceHeight * (0.09 * returnToSupplierList.length)
                                      : Sizes.deviceHeight * (0.09 * 10);
                                  selectedNumberOfRowsAsInt=returnToSupplierList.length < 10? returnToSupplierList.length:10;
                                }if(val=='20'){
                                  listViewLength = returnToSupplierList.length < 20
                                      ? Sizes.deviceHeight * (0.09 * returnToSupplierList.length)
                                      : Sizes.deviceHeight * (0.09 * 20);
                                  selectedNumberOfRowsAsInt=returnToSupplierList.length < 20? returnToSupplierList.length:20;
                                }if(val=='50'){
                                  listViewLength = returnToSupplierList.length < 50
                                      ? Sizes.deviceHeight * (0.09 * returnToSupplierList.length)
                                      : Sizes.deviceHeight * (0.09 * 50);
                                  selectedNumberOfRowsAsInt=returnToSupplierList.length < 50? returnToSupplierList.length:50;
                                }if(val=='all'.tr){
                                  listViewLength = Sizes.deviceHeight * (0.09 * returnToSupplierList.length);
                                  selectedNumberOfRowsAsInt= returnToSupplierList.length;
                                }
                              });
                            },
                          ),
                    ...
                    gapW16,
                    Text(selectedNumberOfRows=='all'.tr?'${'all'.tr} of ${returnToSupplierList.length}':'$start-$selectedNumberOfRows of ${returnToSupplierList.length}',
                        style: const TextStyle(
                            fontSize: 13, color: Colors.black54)),
                    gapW16,
                    InkWell(
...
class MobileReturnToSupplierSummary extends StatefulWidget {
  const MobileReturnToSupplierSummary({super.key});

  @override
  State<MobileReturnToSupplierSummary> createState() => _MobileReturnToSupplierSummaryState();
}

class _MobileReturnToSupplierSummaryState extends State<MobileReturnToSupplierSummary> {
  final TextEditingController filterController = TextEditingController();
  TextEditingController searchController = TextEditingController();
  double listViewLength = 100;
  String selectedNumberOfRows = '10';
                          ...
                          isReturnToSupplierFetched
                            ...
                            child: Column(
                              children: List.generate(
                                returnToSupplierList.length>9?selectedNumberOfRowsAsInt:returnToSupplierList.length,
                                    (index) =>Column(
                                  children: [
                                    Row(
                                      children: [
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              SizedBox(
                                                ...
                                                child: InkWell(
                                                  onTap: () async {
                                                    var res= await deleteQuotation('${returnToSupplierList[index]['id']}');
                                                    ...
                                                    if(res.statusCode==200){
                                                      ...
                                                      setState(() {
                                                        ...
                                                        returnToSupplierList.removeAt(index);
