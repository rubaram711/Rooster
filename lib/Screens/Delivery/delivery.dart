              ...
              child: SingleChildScrollView(
                child: GetBuilder<HomeController>(
                  builder: (homeCont) {
                    ...
                    double expectedDateRow =
                        homeCont.isMenuOpened
                            ? screenWidth > 1250
                                ? MediaQuery.of(context).size.width * 0.18
                                : MediaQuery.of(context).size.width * 0.20
                            : MediaQuery.of(context).size.width * 0.22;
                    double expectedDateFieldWidth =
                        homeCont.isMenuOpened
                            ? screenWidth > 1250
                                ? MediaQuery.of(context).size.width * 0.10
                              ...
                              children: [
                                ...
                                UnderTitleBtn(
                                  ...
                                  onTap: () async {
                                    ...
                                    bool
                                    hasType1WithEmptyTitle = deliveryController
                                        .rowsInListViewInDelivery
                                        .values
                                        .any((map) {
                                    ...
                                    bool
                                    hasType2WithEmptyId = deliveryController
                                        .rowsInListViewInDelivery
                                        .values
                                        .any((map) {
                                    ...
                                    bool
                                    hasType3WithEmptyId = deliveryController
                                        .rowsInListViewInDelivery
                                        .values
                                        .any((map) {
                                    ...
                                    bool
                                    hasType4WithEmptyImage = deliveryController
                                        .rowsInListViewInDelivery
                                        .values
                                        .any((map) {
                                    ...
                                    bool
                                    hasType5WithEmptyNote = deliveryController
                                        .rowsInListViewInDelivery
                                        .values
                                        .any((map) {
                                    ...
                                    ReusableButtonWithColor(
                                      ...
                                      onTapFunction: () async {
                                        ...
                                        bool hasType2WithEmptyId =
                                            deliveryController.newRowMap.values
                                                .any((map) {
              ...
              builder: (homeCont) {
                double itemRow =
                    homeCont.isMenuOpened
                        ? MediaQuery.of(context).size.width * 0.12
                        : MediaQuery.of(context).size.width * 0.15;
                double itemFieldWidth =
                    homeCont.isMenuOpened
                        ? MediaQuery.of(context).size.width * 0.12
                        : MediaQuery.of(context).size.width * 0.15;
                double descriptionRow =
                    homeCont.isMenuOpened
                        ? MediaQuery.of(context).size.width * 0.27
...
class _ReusableImageRowState extends State<ReusableImageRow> {
  ...
  void initState() {
    imageFile =
        deliveryController.rowsInListViewInDelivery[widget.index]['image'];
    super.initState();
  }
