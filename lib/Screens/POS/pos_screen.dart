...
class _PosScreenState extends State<PosScreen> {
                          ...
                          onTapFunction: () async {
                            if (posController.selectedWarehouseId == '') {
                              CommonWidgets.snackBar(
                                  'error', 'you must choose warehouses first');
  ...
  Widget _generalTabInPos() {
    return GetBuilder<PosController>(builder: (posCont) {
      return Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Container(
...
class PosAsRowInTable extends StatefulWidget {
  const PosAsRowInTable(
      {super.key,
      required this.info,
      required this.index,
  ...
  @override
  State<PosAsRowInTable> createState() => _PosAsRowInTableState();
}

class _PosAsRowInTableState extends State<PosAsRowInTable> {
  ...
  @override
  Widget build(BuildContext context) {
    return GetBuilder<PosController>(builder: (cont) {
      return InkWell(
        onDoubleTap: () {
          showDialog<String>(
              context: context,
          ...
          child: Center(
            child: Row(
              ...
              children: [
                ...
                TableItem(
                  text: widget.info['warehouse'] != null
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: DropdownMenu<String>(
                      ...
                      // menuStyle: ,
                      menuHeight: 250,
                      dropdownMenuEntries: warehouseController
                          .warehousesNameList
