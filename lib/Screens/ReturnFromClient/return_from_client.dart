...
class _CreateNewReturnFromClientState extends State<CreateNewReturnFromClient> {
  ...
  bool isReturnFromClientsInfoFetched = false;
  ...
  getFieldsForCreateQuotationFromBack() async {
    ...
    // var p = await getFieldsForCreateReturnFromClient();
    ...
    if ('$p' != '[]') {
      setState(() {
        ...
        isReturnFromClientsInfoFetched = true;
      });
    }
  }
...
class MobileCreateNewReturnFromClient extends StatefulWidget {
  const MobileCreateNewReturnFromClient({super.key});

  @override
  State<MobileCreateNewReturnFromClient> createState() =>
