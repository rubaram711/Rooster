...
class CreateNewPurchaseInvoice extends StatefulWidget {
  ...
  @override
  State<CreateNewPurchaseInvoice> createState() =>
      _CreateNewPurchaseInvoiceState();
}
...
class _MobileCreateNewPurchaseInvoiceState
    extends State<MobileCreateNewPurchaseInvoice> {
  // bool imageAvailable=false;
